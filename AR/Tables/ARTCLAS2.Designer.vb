...
Partial Class ARTCLAS2
    ...
    Private Sub InitializeComponent()
        ...
        Me.UltraLabel1.Text = "Store Class Code"
        '
        'UltraTextEditor2
        '
        Me.Absx1.SetABSColumnName(Me.UltraTextEditor2, "CUST_STORE_CLASS_DESC")
        ...
        'UltraTextEditor1
        '
        Me.Absx1.SetABSColumnName(Me.UltraTextEditor1, "CUST_STORE_CLASS_CODE")
