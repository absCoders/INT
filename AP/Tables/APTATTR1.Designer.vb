...
Partial Class APTATTR1
    ...
    Private Sub InitializeComponent()
        ...
        'UltraTextEditor2
        '
        Me.Absx1.SetABSColumnName(Me.UltraTextEditor2, "VEND_ATTR_DESC")
        ...
        Me.UltraTextEditor2.TabIndex = 55
        '
        'UltraTextEditor1
        '
        Me.Absx1.SetABSColumnName(Me.UltraTextEditor1, "VEND_ATTR_CODE")
        ...
        Me.UltraTextEditor1.TabIndex = 54
        '
        'APTATTR1
        '
