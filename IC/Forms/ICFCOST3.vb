...
#Region "ABS Standard Routines" ' These Routines should be found in all Forms which Launch from the Menu.
    ...
    Private Sub Form_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ASCMAIN1.sql = "Select OPS_YYYYPP, LEGEND from GLTPARM2" _
         & " where OPS_YYYYPP <= '" & ASCMAIN1.Period_Calc(ASCMAIN1.CYP, 12) & "'" _
         & "   and OPS_YYYYPP >= '" & ASCMAIN1.CYP & "'"

        Dim dvw3 As DataView = ASCDATA1.GetDataTable.DefaultView
        dvw3.Sort = "OPS_YYYYPP"
        cmbITEM_COSTF_YP.DataSource = dvw3
        cmbITEM_COSTF_YP.ValueMember = "OPS_YYYYPP"
        cmbITEM_COSTF_YP.DisplayMember = "LEGEND"
        'cmbITEM_COSTF_YP.Value = ASCMAIN1.CYP
        ...
        Bind_Controls(grpICTCOSTM, "ICTITEM1")
    ...
    Overrides Sub Proceed_PreReq(ByVal eItemKey As String)
        ...
        Select Case eItemKey
            ...
            Case "Update"
                ...
                If rowICTCOSTM.Item("SEQ") & "" = "2" And rowICTCOSTM.Item("SEQ_DESC") & "" = "Fut" Then
                    Dim ITEM_COST_STATUS As String = rowICTITEM1.Item("ITEM_COST_STATUS") & ""
                    If ITEM_COST_STATUS = "P" Then
                        ' do nothing
                    Else
                        If cmbITEM_COSTF_YP.Value & "" = "" Then
                            EMsg &= vbCrLf & "Future Cost Must have a Future Cost YP"
                        End If
                    End If
    ...
    Sub Clear_Record()
        ...
        ASCMAIN1.sql = "Select ICTCOSTF.*, ICTITEM1.ITEM_COSTF_YP from ICTCOSTF,ICTITEM1 where ICTCOSTF.ITEM_EXP_IMP_IND = 'E' and ICTITEM1.ITEM_CODE = ICTCOSTF.ITEM_CODE"
        For Each row As DataRow In ASCDATA1.GetDataTable.Select("")
            rowICTCOSTM = Add_ICTCOSTM(2, row, True)
        Next
    ...
    Sub Update_Record()
        ...
        Else
            ASCMAIN1.sql = "Update ICTITEM1 Set ITEM_COSTF_YP = :PARM1 where ITEM_CODE = :PARM2"
            ASCDATA1.ExecuteSQL(ASCMAIN1.sql, "VV", New String() {cmbITEM_COSTF_YP.Value, ITEM_CODE})
        End If
...
#End Region
    ...
    Function Add_ICTCOSTM(SEQ As Integer, row As DataRow, Optional YPinRow As Boolean = False) As DataRow

        Dim rowICTCOSTM As DataRow = dst.Tables("ICTCOSTM").NewRow
        If row IsNot Nothing Then
            For Each dcol As DataColumn In row.Table.Columns
                If dcol.ColumnName <> "ITEM_COSTF_YP" Then
    ...
    Private Sub grdICTCOSTM_AfterRowActivate(sender As Object, e As EventArgs) Handles grdICTCOSTM.AfterRowActivate
        cmbITEM_COSTF_YP.Visible = (grdICTCOSTM.ActiveRow.Cells("SEQ").Value = 2) And Not lblInitialCost.Visible
        lblITEM_COSTF_YP.Visible = (grdICTCOSTM.ActiveRow.Cells("SEQ").Value = 2) And Not lblInitialCost.Visible
    End Sub
End Class