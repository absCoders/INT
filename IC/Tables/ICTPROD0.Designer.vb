...
Partial Class ICTPROD0
    ...
    Private Sub InitializeComponent()
        ...
        Me.UltraLabel1.Text = "Product Type"
        '
        'UltraTextEditor1
        '
        Me.Absx1.SetABSColumnName(Me.UltraTextEditor1, "PROD_TYPE_CODE")
        ...
        'UltraTextEditor2
        '
        Me.Absx1.SetABSColumnName(Me.UltraTextEditor2, "PROD_TYPE_DESC")
