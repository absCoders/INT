Public Class TAFCONV2
    ...
    Public Sub New(ByVal FF As ASFBASE1, ByVal TABLE_NAME As String, ByVal TABLE_KEY As String)
        frmASFBASE1 = FF
        ...
        ElseIf EntryMode = "V" Or EntryMode = "E" Then
            If rowTATCONV1("CONV_FOLLOWUP_BY") & "" <> "" Then
                If rowTATCONV1("CONV_FOLLOWUP_CONV_NO") & "" <> "" Then
                    ...
                    Dim row As DataRow = frmASFBASE1.dst.Tables("TATCONV1").Rows.Find(rowTATCONV1("CONV_FOLLOWUP_CONV_NO"))
    ...
    Function Update_Log(ByVal display_errors As Boolean) As String
        ...
        ElseIf EntryMode = "E" Then
            rowTATCONV1.ItemArray = frmASFBASE1.dst.Tables("TATCONV1").Rows(0).ItemArray
            'rowTATCONV1("LAST_OPER") = TAC.TACMAIN1.myEMPLOYEE_CODE ' ASCMAIN1.USER_ID
            'rowTATCONV1("LAST_DATE") = DATETIME_STAMP ' Now + ASCMAIN1.NowTSD
        End If
        If chkFollowUp.Checked Then
    ...
    Optional ByVal CONV_FOLLOWUP_DATE As Date = Nothing) As String
        ...
        'Absx1.txtFor("CONV_SUBJECT").Text = CONV_SUBJECT
        'Absx1.txtFor("CONV_NOTES").Text = CONV_NOTES
        rowTATCONV1.Item("CONV_SUBJECT") = CONV_SUBJECT
        rowTATCONV1.Item("CONV_NOTES") = CONV_NOTES

        If CONV_FOLLOWUP_BY <> "" Then

            'Absx1.txtFor("CONV_FOLLOWUP_BY").Text = CONV_FOLLOWUP_BY
            'Absx1.dteFor("CONV_FOLLOWUP_DATE").Value = CONV_FOLLOWUP_BY
