Public Class RSCSPRO1 ' Store Profile
    Inherits WHCRPTS1
    ...
    Public Overrides Property reportName() As String = "RSRSPRO0"
    ...
    Private Sub InitializeReportSettings(clientData As Dictionary(Of String, Object))
        CUST_CODE = clientData("CUST_CODE")
        CUST_STORE_NOs.Add(clientData("CUST_STORE_NO"))

        SUBT = ASCDATA1.GetDataValue("SELECT CUST_STORE_NAME FROM ARTCUST2 WHERE CUST_CODE=:PARM1 AND CUST_STORE_NO=:PARM2", "VV", New Object() {CUST_CODE, clientData("CUST_STORE_NO")})
        RYW = clientData("RYW")
    ...
    Private Sub LoadBaseReportData()
        ...
        WEEK_LEGEND = "Week Ending " & Format(rowGLTPARM3.Item("WEEK_END_DATE"), "MM/dd/yy") & ",  " & rowGLTPARM3.Item("LEGEND")
