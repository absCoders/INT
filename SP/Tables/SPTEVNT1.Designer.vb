...
Partial Class SPTEVNT1
    ...
    Private Sub InitializeComponent()
        ...
        Me.UltraLabel1.Text = "Event Type"
        '
        'UltraTextEditor1
        '
        Me.Absx1.SetABSColumnName(Me.UltraTextEditor1, "EVENT_TYPE_CODE")
        ...
        'UltraTextEditor2
        '
        Me.Absx1.SetABSColumnName(Me.UltraTextEditor2, "EVENT_TYPE_DESC")
