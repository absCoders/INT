...
#Region "ABS Standard Routines" ' These Routines should be found in all Forms which Launch from the Menu.
    ...
    Private Sub Form_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        With dst
            ...
            Create_TDA(.Tables.Add, "RSTBUDR1", "*")
            Create_BAs("RSTBUDR1")
    ...
    Overrides Sub Proceed_PreReq(ByVal eItemKey As String)
        ...
        Select Case eItemKey
            ...
            Case "Load"
                ...
                If EMsg = "" Then
                    If Not ASCMAIN1.Logical_Lock("RSTBUDR1", "*") Then
                        Exit Sub
                    End If
                End If
        ...
        For Each rowRSTBUDRX As DataRow In dst.Tables("RSTBUDRX").Select("")
            For I As Integer = 1 To MOS
                ...
                If BUDGET <> 0 Then
                    ...
                    rowRSTBUDR1.Item("COLLECTION_CODE") = rowRSTBUDRX.Item("COLLECTION_CODE")
                    rowRSTBUDR1.Item("CUST_CODE") = rowRSTBUDRX.Item("CUST_CODE")
                    rowRSTBUDR1.Item("CUST_STORE_NO") = rowRSTBUDRX.Item("CUST_STORE_NO")
                    rowRSTBUDR1.Item("OPS_YYYYPP") = YPs(I)
                    rowRSTBUDR1.Item("ITEM_CATGY_CODE") = "E"
                    rowRSTBUDR1.Item("BUDGET") = BUDGET
...
#End Region
    ...
    Sub Setup_grd()
        ...
        grdRSFBUDRX.Text = "Retail Sales Budgets, by Store/Month, for " & RYP_LEGENDS & " - " & COLLS
    ...
    Sub Create_Work_Tables()
        ...
        For I As Integer = 1 To 12
            ...
            If YP > RYP1 Then YP = ""
            sqlM &= ", Sum (Decode(RSTBUDR1.OPS_YYYYPP,'" & YP & "',BUDGET,0)) BUDGET_P" & Format(I, "00")
        Next

        ASCMAIN1.sql = "Select RSTBUDR1.COLLECTION_CODE, RSTBUDR1.CUST_CODE, RSTBUDR1.CUST_STORE_NO" & vbCrLf _
            & sqlM _
            & " from RSTBUDR1,ARTCUST2" _
            & " where RSTBUDR1.OPS_YYYYPP between '" & RYP0 & "' and '" & RYP1 & "'" & vbCrLf _
            & "   and ARTCUST2.CUST_CODE = RSTBUDR1.CUST_CODE and ARTCUST2.CUST_STORE_NO = RSTBUDR1.CUST_STORE_NO" & vbCrLf _
            & IIf(CUST_CODE = "", "", "   and RSTBUDR1.CUST_CODE = '" & CUST_CODE & "'" & vbCrLf) _
            & IIf(SELL_CODE = "", "", "   and ARTCUST2.SELL_CODE = '" & SELL_CODE & "'" & vbCrLf) _
            & IIf(BRAND_CODE = "", "", "" _
                  & " and RSTBUDR1.COLLECTION_CODE in " _
                  & " (Select COLLECTION_CODE FROM ICTCOLL1 where BRAND_CODE = '" & BRAND_CODE & "')" & vbCrLf) _
            & " group by RSTBUDR1.COLLECTION_CODE, RSTBUDR1.CUST_CODE, RSTBUDR1.CUST_STORE_NO"
