...
#Region "ABS Standard Routines" ' These Routines should be found in all Forms which Launch from the Menu.
    ...
    Sub Form_Load_ABS()
        ...
        If MENU_ITEM_OBJECT = "SAFANAL1" Then
            QCOLS.Add("RSLS_QTY", "NVL(RSTRETL1.QTY_SOLD,0)")
            QCOLS.Add("RSLS_AMT", "NVL(RSTRETL1.AMT_SOLD,0)")
            QCOLS.Add("RONH_QTY", "NVL(RSTRETL1.QTY_EOW,0)")
            QCOLS.Add("RONH_AMT", "NVL(RSTRETL1.QTY_EOW,0)*NVL(ICTITEM1.ITEM_RETAIL_PRICE,0)")
            ...
            QCOLS.Add("WSLS_CGS", "NVL(SOTINVH2.ORDR_QTY_SHIP,0)*DECODE(SOTINVH2.WHSE_CODE,NULL,0,NVL(SOTINVH2.ITEM_UNIT_COST,0))")
            QCOLS.Add("WSLS_GPA", "NVL(SOTINVH2.ORDR_QTY_SHIP,0)*(NVL(SOTINVH2.ORDR_UNIT_PRICE,0) - DECODE(SOTINVH2.WHSE_CODE,NULL,0,NVL(SOTINVH2.ITEM_UNIT_COST,0)))")
        ...
        With dst
            ...
            If ASCMAIN1.DBS_SERVER = "ANE" Or ASCMAIN1.DBS_COMPANY = "ANE" Then
            Else
                ASCMAIN1.sql = "Select * from SOTINVH2"
                Create_TDA(.Tables.Add, "SOTINVH2", "**", 0)
                'With .Tables("SOTINVH0").Columns
                '    .Add("SLSGP", GetType(System.Decimal), "QTY_UNITS * ORDR_PRICE_GRS")
                '    .Add("SLSNP", GetType(System.Decimal), "QTY_UNITS * ORDR_PRICE_NET")
                '    .Add("EXT_REBATE", GetType(System.Decimal), "QTY_UNITS * REBATE")
                '    .Add("STD_COST", GetType(System.Decimal), "IIF(QTY_UNITS=0,0,STD_COST_EXT / QTY_UNITS)")
                '    .Add("ADJ_COST", GetType(System.Decimal), "IIF(QTY_UNITS=0,0,ADJ_COST_EXT / QTY_UNITS)")
                'End With
            End If
...
#End Region
                    ...
                    Case "0"
                        ...
                        With dst.Tables("SATANALO").Rows
                            ...
                            Else
                                ...
                                .Add(New String() {"RSLS_AMT", "Rtl Amt Sold", "1", ""})
    ...
    Sub Generate_Inquiry(ByVal refresh_data As Boolean)
        ...
        If refresh_data Then
                        ...
                        If optMW.Value = "P" Then
                            If M = 1 Then
                                ...
                                If ICTITEM1 = "" Or ICTITEM1_RYP <> RYP Then
                                    ICTITEM1 = TAC.RSCMAIN1.Get_ICTITEM1_Hist_CATGY(RYP, True)
                                    ICTITEM1_RYP = RYP
                                End If
            ...
            'sqlSOTINVH0(0) = Replace(Replace(sqlw, "YX_MIN", YX_MIN_TOTAL), "YX_MAX", YX_MAX_TOTAL)
